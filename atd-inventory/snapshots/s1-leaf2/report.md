...
---------- ------------------------ ---------------------- ---
Et1           s1-leaf1.atd.lab         Ethernet1           120
Et2           s1-spine1.atd.lab        Ethernet3           120
Et3           s1-spine2.atd.lab        Ethernet3           120
Et4           s1-host1.atd.lab         Ethernet2           120
Et6           s1-leaf1.atd.lab         Ethernet6           120
```
## show running-config
...
Arista cEOSLab
Hardware version: 
Serial number: s1-leaf2
Hardware MAC address: 001c.73c0.c613
System MAC address: 001c.73c0.c613
